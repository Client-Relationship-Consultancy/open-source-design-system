...
SelectValueRenderer.prototype.svg = function() {
  return (
    '<style>svg:not(:root).svg-inline--fa {overflow: visible;}.svg-inline--fa.fa-w-14 {width: 0.875em;}.fa-1x {font-size: 1em;}.svg-inline--fa {display: inline-block;font-size: inherit;height: 1em;overflow: visible;vertical-align: -0.125em;}</style><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-down" class="svg-inline--fa fa-chevron-down fa-w-14 fa-1x sc-iwsKbI clbLNE" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" color="black" shade="main" theme="[object Object]">' +
