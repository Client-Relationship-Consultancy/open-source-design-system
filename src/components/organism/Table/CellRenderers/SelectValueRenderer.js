...
SelectValueRenderer.prototype.svg = function() {
  return (
    '<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-down" class="dropdown-icon-select-renderer" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" color="black" shade="main" theme="[object Object]">' +
